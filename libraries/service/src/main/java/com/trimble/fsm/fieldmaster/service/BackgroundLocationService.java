...
public class BackgroundLocationService extends Service implements
    ...
    public void onCreate() {
        ...
        if (!servicesAvailable || mLocationClient.isConnected() || mInProgress)
            return;
        //Toast.makeText(this, DateFormat.getDateTimeInstance().format(new Date()) + ": Initiating Start", Toast.LENGTH_SHORT).show();
        //appendLog(DateFormat.getDateTimeInstance().format(new Date()) + ": Initiating Start", Constants.LOG_FILE);
    ...
    public void onDestroy() {
        ...
        mInProgress = false;
        if (servicesAvailable && mLocationClient != null && mLocationClient.isConnected()) {
